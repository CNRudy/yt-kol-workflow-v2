...
INFLUENCER_COLUMNS = _columns_from_schema(
    INFLUENCERS_FIELDS,
    {
        ...
        "邮箱状态": "email_status",
        "邮箱来源": "email_source",
        "邮箱出现视频数": "email_hit_videos",
        "候选邮箱": "email_candidates",
        "亚马逊推广经验": "amazon_promo_level",
        "Amazon带货视频数": "amazon_promo_video_count",
        "推广视频数": "promo_video_count",
        "Amazon Storefront": "amazon_storefront_url",
        "推广证据": "promo_evidence",
        "匹配产品": "match_profile",
        "品牌匹配度": "brand_fit_score",
        "内容契合类型": "content_types",
